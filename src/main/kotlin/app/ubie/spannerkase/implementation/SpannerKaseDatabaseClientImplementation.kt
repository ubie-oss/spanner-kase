package app.ubie.spannerkase.implementation

import app.ubie.spannerkase.SchemeHistory
...
internal class SpannerKaseDatabaseClientImplementation(
    ...
    override fun createSchemeHistory() {
...
"""
    ...
    override fun allSchemeHistory(): List<SchemeHistory> {
        val sql =
            //language=SQL
            """
SELECT
...
ORDER BY InstalledRank
    ...
    override fun insertSchemeHistory(schemeHistory: SchemeHistory) {
